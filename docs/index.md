<div align="center">
  <img src="assets/logo.png" alt="fdx logo" width="180" />
</div>
...
!!! info
    If you need the full feature set (PDE solvers, boundary handling helpers, rich stencils), consider the original [findiff](https://github.com/maroba/findiff).

## Installation

As `fdx` is not yet on PyPI, you can install it locally by cloning the repository and running:

```bash
pip install jax  # or jax[cuda] for GPU
git clone https://github.com/lenardrommel/fdx.git
cd fdx
pip install -e .
```
...
Check out the [Vector Operators](vector.md) page for detailed documentation.
